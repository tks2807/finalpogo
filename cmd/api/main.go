...
func main(){
	...
	flag.StringVar(&cfg.env, "env", "development", "Enviroment (d|s|p)")

	flag.StringVar(&cfg.db.dsn,"db-dsn","postgres://manga:password@localhost/manga?sslmode=disable","PostgreSQL DSN")
